...
const clientIds = state => state.clients.ids

const clientApi = state => state.api

const clientSearch = state => state.clients.search


const getClientsSelector  = createSelector(
    [clientApi,clientIds,clientSearch],
    (api,ids,search) => {
        return getClients(api,ids,search)
    }
)
